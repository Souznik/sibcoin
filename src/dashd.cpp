 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Sibcoin (http://www.sibcoin.io/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to sibcoind / RPC client
            std::string strUsage = _("Sibcoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  sibcoind [options]                     " + _("Start Sibcoin Core Daemon") + "\n" +
                _("Usage (deprecated, use sibcoin-cli):") + "\n" +
                  "  sibcoind [options] <command> [params]  " + _("Send command to Sibcoin Core") + "\n" +
                  "  sibcoind [options] help                " + _("List commands") + "\n" +
                  "  sibcoind [options] help <command>      " + _("Get help for a command") + "\n";
