...
const char* BITCOIN_REQUEST_MIMETYPE = "application/sibcoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/sibcoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/sibcoin-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // sibcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Sibcoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
