...
##perform gitian builds
 ...
 Build sibcoind and sibcoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit sibcoin=v${VERSION} ../sibcoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../sibcoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r sibcoin-${VERSION}-linux-gitian.zip *
	mv sibcoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit sibcoin=v${VERSION} ../sibcoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../sibcoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r sibcoin-${VERSION}-win-gitian.zip *
	mv sibcoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit sibcoin=v${VERSION} ../sibcoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
