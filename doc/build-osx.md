...
sibcoind/sibcoin-cli binaries are not included in the Bitcoin-Qt.app bundle.

If you are building `sibcoind` or `Bitcoin-Qt` for others, your build machine should be set up
